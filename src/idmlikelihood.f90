...
!---------- calcul de la vraisemblance ------------------
        ...
        do i=1,no0
				...
				if(gausspoint.eq.15) then
					...
					call qgaussPL21(c(i),t1(i),t2(i),the01,the12,the02,res2, &
                            vet01,vet12,vet02)
					else 
						if(gausspoint.eq.31) then
						call qgaussPL31(c(i),t1(i),t2(i),the01,the12,the02,res2, &
                            vet01,vet12,vet02)
						else
							if(gausspoint.eq.41) then
							call qgaussPL41(c(i),t1(i),t2(i),the01,the12,the02,res2, &
                            vet01,vet12,vet02)
							else
								if(gausspoint.eq.51) then
								call qgaussPL51(c(i),t1(i),t2(i),the01,the12,the02,res2, &
                            vet01,vet12,vet02)
								else 
									call qgaussPL61(c(i),t1(i),t2(i),the01,the12,the02,res2, &
                            vet01,vet12,vet02)
								end if
							end if 
						end if 
			...
			if(gausspoint.eq.10) then
				...
				if(gausspoint.eq.10) then
					...
					if(gausspoint.eq.15) then
						...
						if(gausspoint.eq.21) then
							call qgaussPL21(c(i),t1(i),t2(i),the01,the12,the02,&
                            res2,vet01,vet12,vet02)
						else 
							if(gausspoint.eq.31) then
								call qgaussPL31(c(i),t1(i),t2(i),the01,the12,the02,&
                            res2,vet01,vet12,vet02)
							else
								if(gausspoint.eq.41) then
									call qgaussPL41(c(i),t1(i),t2(i),the01,the12,the02,&
                            res2,vet01,vet12,vet02)
								else
									if(gausspoint.eq.51) then
										call qgaussPL51(c(i),t1(i),t2(i),the01,the12,the02,&
                            res2,vet01,vet12,vet02)
									else 
										call qgaussPL61(c(i),t1(i),t2(i),the01,the12,the02,&
                            res2,vet01,vet12,vet02)
									end if
								end if 
							end if 
				...
				if(gausspoint.eq.10) then
						...
						if(gausspoint.eq.21) then
							call qgaussPL21(c(i),t1(i),t3(i),the01,the12,the02,&
							res2,vet01,vet12,vet02)
                                
						else 
							if(gausspoint.eq.31) then
								call qgaussPL31(c(i),t1(i),t3(i),the01,the12,the02,&
								res2,vet01,vet12,vet02)
                                
							else
								if(gausspoint.eq.41) then
									call qgaussPL41(c(i),t1(i),t3(i),the01,the12,the02,&
									res2,vet01,vet12,vet02)
                                
								else
									if(gausspoint.eq.51) then
										call qgaussPL51(c(i),t1(i),t3(i),the01,the12,the02,&
										res2,vet01,vet12,vet02)
                                
									else 
										call qgaussPL61(c(i),t1(i),t3(i),the01,the12,the02,&
										res2,vet01,vet12,vet02)
...
!================================  QGAUS15   ==========================
      subroutine qgaussPL15(cas,a,b,the01,the12,the02,res,v1,v2,v3)
...
!================================  QGAUS21   ==========================
      subroutine qgaussPL21(cas,a,b,the01,the12,the02,res,v1,v2,v3)
...
!================================  QGAUS31   ==========================
      subroutine qgaussPL31(cas,a,b,the01,the12,the02,res,v1,v2,v3)
...
!================================  QGAUS41   ==========================
      subroutine qgaussPL41(cas,a,b,the01,the12,the02,res,v1,v2,v3)
...
!================================  QGAUS51   ==========================
      subroutine qgaussPL51(cas,a,b,the01,the12,the02,res,v1,v2,v3)
...
!================================  QGAUS61   ==========================
      subroutine qgaussPL61(cas,a,b,the01,the12,the02,res,v1,v2,v3)
...
subroutine qgausscas2weib(a,b,the01,the02,the12,resdenum,&
...
!---------- calcul des derivees premiere ------------------   
	...
	res = 0
        do i=1,no0
			...
			call fonct(t3(i),the12,ri12,gl12,su12)
			call qgausscas2weib(t1(i),t2(i),the01,&
			...
			call fonct(t3(i),the12,ri12,gl12,su12)
			call qgausscas2weib(t1(i),t2(i),the01,the02,the12,&
			...
			do j=1,nva02nofix
			   ...
			   lfix=lfix+nva12nofix
				...
				call fonct(t3(i),the02,ri02,gl02,su02)
				call fonct(t3(i),the12,ri12,gl12,su12)
        			call qgausscas2weib(t1(i),t3(i),the01,the02,&
	...
	res = 0
        do i=1,no0
			...
			res1((nvamax0212+1):nvamax12)=0
                ...
                if(c(i).eq.2)then ! cpi 0-->1
			call susp(t3(i),the12,nz12,su12,ri12,zi12,gl12)
			call qgausscas2PL(t1(i),t2(i),the01,&
			the02,the12,res2denum,res201num,&
			res202num,res212num,res20101num,&
			res20102num,res20112num,res20202num,&
			res20212num,res21212num,&
			...
			call susp(t3(i),the12,nz12,su12,ri12,zi12,gl12)
			call qgausscas2PL(t1(i),t2(i),the01,the02,the12,&
			res2denum,res201num,res202num,res212num,&
			res20101num,res20102num,&
			res20112num,res20202num,res20212num,&
			res21212num,vet01,vet02,vet12)
			...
			do j=1,nva02nofix
			   ...
			   lfix=lfix+nva12nofix
				...
				call susp(t3(i),the02,nz02,su02,ri02,zi02,gl02)
			        call susp(t3(i),the12,nz12,su12,ri12,zi12,gl12)
				call qgausscas2PL(t1(i),t3(i),the01,the02,the12,&
				res2denum,res201num,res202num,res212num,res20101num,&
				res20102num,res20112num,res20202num,res20212num,&
				res21212num,vet01,vet02,vet12)
				...
				call susp(t3(i),the02,nz02,su02,ri02,zi02,gl02)
			        call susp(t3(i),the12,nz12,su12,ri12,zi12,gl12)
        			call qgausscas2PL(t1(i),t3(i),the01,the02,&
        			the12,res2denum,res201num,res202num,res212num,&
        			res20101num,res20102num,&
			  	res20112num,res20202num,res20212num,res21212num,&
        			vet01,vet02,vet12)
...
subroutine qgausscas2PL(a,b,the01,the02,the12,resdenum,&
		res01num,res02num,res12num,res0101num,res0102num,res0112num,&
		res0202num,res0212num,res1212num,v01,v02,v12)
